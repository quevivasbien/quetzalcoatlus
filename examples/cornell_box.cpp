...
int main() {
    ...
    EmissiveMaterial emissive_material(SolidColor(1.0f, 1.0f, 1.0f));
    scene.add_sphere(Pt3(0.f, 1.f, -2.f), 0.5f, &emissive_material);
    LambertMaterial lambert_material(SolidColor(1.0f, 0.5f, 0.5f));
    scene.add_sphere(Pt3(0.f, 0.f, -2.f), 0.5f, &lambert_material);
    scene.commit();
