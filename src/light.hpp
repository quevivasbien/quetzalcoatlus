...
public:
    ...
    virtual std::optional<LightSample> sample(const Pt3& p, const WavelengthSample& wavelengths, Vec2 sample2) const = 0;
...
public:
    ...
    std::optional<LightSample> sample(const Pt3& p, const WavelengthSample& wavelengths, Vec2 sample2) const override;
